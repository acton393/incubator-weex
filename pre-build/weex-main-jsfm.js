(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.25.0-beta.2, Build 2018-03-21 19:48. (Vue: 2.5.11-weex.1, Rax: 0.4.20)');
...
var subversion = {"framework":"0.25.0-beta.2","transformer":">=0.1.5 <0.5"};
...
function getJSFMVersion () {
  ...
  return "0.25.0-beta.2" // eslint-disable-line
}
